...
USBHost turbohub;
USBHub hub1(turbohub);
USBHub hub2(turbohub);
USBHub hub3(turbohub);
USBHub hub4(turbohub);
MIDIDevice midi01(turbohub);
MIDIDevice midi02(turbohub);
MIDIDevice midi03(turbohub);
MIDIDevice midi04(turbohub);
MIDIDevice midi05(turbohub);
MIDIDevice midi06(turbohub);
MIDIDevice midi07(turbohub);
MIDIDevice midi08(turbohub);
MIDIDevice midi09(turbohub);
MIDIDevice midi10(turbohub);
...
void setup() {
  ...
  delay(1500);
  Serial.println("TurBoHub is a TurBoss Creation");
  Serial.println("6 Serial Midi Ports");
  Serial.println("10 USB MIDI Ports");
  delay(10);
  turbohub.begin();
  digitalWrite(13, LOW);
}
